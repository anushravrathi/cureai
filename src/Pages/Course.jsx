...
const Course = () => {
  ...
  return (
    ...
    <div className="w-screen h-auto px-[10px]  xl:px-[80px]  xl:py-[40px]">
        <h1 className='sm:text-[90px] text-[50px] xl:text-[128px] sm:text-black lg:text-theme-200 xl:text-theme-200 xl:leading-[100px]  font-bold text-center'>CURE.AI<br/></h1>
<p className='sm:text-[17px] xl:text-[20px] px-[30px] pt-[20px] xl:pt-[50px] text-[#adadad]'>Cure.ai: Empowering Early Intervention with AI-Driven Disease Detection Solutions</p>
    </div>

    <div className="w-screen h-auto px-[80px] py-[40px]">
        <p className=" text-black  sm:text-[40px] xl:text-[64px] text-left pb-[40px] " >Services</p>
