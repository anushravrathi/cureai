  ...
  <div className="container px-4 mx-auto">
    ...
    <div className="md:flex md:flex-wrap md:-mx-4 py-6 md:pb-12">
      ...
      <div className="footer-info lg:w-1/3 md:px-4">
        <h4 className="text-white text-2xl mb-4">Cure.AI</h4>
      ...
      <div className="md:w-1/3 md:px-4 md:text-center mt-12 lg:mt-0">
        <h5 className="text-lg text-white font-medium mb-4">Explore Our Services</h5>
    ...
    <div className="container px-4 mx-auto">
      ...
      <div className="md:flex md:-mx-4 md:items-center">
        <div className="md:flex-1 md:px-4 text-center md:text-left">
          <p className="text-white">&copy; <strong>Anushrav Rathi</strong></p>
        </div>
